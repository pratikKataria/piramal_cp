...
class CPEventGuestScreen extends StatefulWidget {
  final String eventId;
  const CPEventGuestScreen(this.eventId, {Key key}) : super(key: key);

  @override
  _CPEventGuestScreenState createState() => _CPEventGuestScreenState();
}

class _CPEventGuestScreenState extends State<CPEventGuestScreen> implements CPEventView {
  ...
  void initState() {
    ...
    presenter.getEventGuestList(context, widget.eventId);
  }
